...
Use functions from JavaScript 1.6, 1.7 & 1.8 even in older browsers.
...
* Run @pupu install js-edge@ inside of your application
...
* "Source Code":http://github.com/botanicus/pupu-js-edge
